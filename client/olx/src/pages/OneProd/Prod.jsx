                ...
                <div className="container">
                    <div className="a1">
                        ...
                        <div>
                            <div className="boxs">
                                <div className='box_1'>
                                    <Link to={`/prod/${prod?._id}`} className='Prod-content'>
                            ...
                            <div className="box2">
                                ...
                                <div className='profil_link'>
                                    ...
                                    <div className="profil_link_date">
                                        <span><Link to="/">Abdulajon</Link> </span><br />
                                        <span><Link to="/"> OLXda 2024 M08 beri</Link></span><br />
                    ...
                    <div className='a2'>
                        <div className='a2_futers'>
                            ...
                            <div className='tags'>
                                ...
                                <button className="teg_car">  Bosgan yo'li:2 km</button>
                                <button className="teg_car">  Uzatmalar qutisi: automat</button>
                                <button className="teg_car">  Rang: black</button>
                                <button className="teg_car">  Dvigatel hajmi: 400l</button>
                                <button className="teg_car">  Yoqilg'i turi: gas</button>
                                <button className="teg_car">  state: Yaxshi</button>
                                <button className="teg_car">  Mulkdorlar soni: 1</button>
                            </div>
                            <div className="text_a2">
                                <h3>TAVSIF</h3>
                                <div className="text_a2">
                                    <span>Twin turbo Premier</span> <br />
                                    <span>2020-2023</span> <br />
                                    <span>2km</span> <br />
                                    <span>He одного царапины. </span> <br />
                                    <span>Можате проверить в любом месте </span> <br /><br />
                                    <span>B комплекте зимние шины </span> <br />
                                    <span>тонеровка до января </span> <br />
                                </div>
                            </div>
                            <br /><br />
