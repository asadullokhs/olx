            ...
            <div className='prodbody2'>
                ...
                <div className="container">
                    <div className="a1">
                        ...
                        <div className="carousel" style={{width: "930px", margin:"2px", padding:"40px", backgroundColor: "#fff"}}>
                           <Slider {...settings }>
                ...
                {
                    modal && <div className='mesage_modal' style={{ position: "fixed", bottom: "400px", right: "250px", backgroundColor: "red" }}>

                        <div className="message_modal1">
                            <div className="modal1_img">
                            ...
                            <div className="modal-body">
                                <div className="box d-flex">
                                    <img className='img_mesage_modal' src={prod?.photos[0].url} alt="" />
                                    <p className="text-truncate" style={{}}>{prod?.name} </p>
                                </div>
                            </div>
