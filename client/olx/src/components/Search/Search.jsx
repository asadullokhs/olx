    ...
    return (
        <div className="container">
            <div className='Search_Com'  >
                ...
                <button className='Search_btn' style={{display:"flex", alignItems: "center", justifyContent: "center"}}> <p style={{marginTop:"10px"}}>Qidruv</p> <i style={{margin:"7px"}} class="fa-solid fa-magnifying-glass"></i></button><div className='bell'><i class="fa-regular fa-bell"></i></div>
            </div>
        </div>
    )
}
